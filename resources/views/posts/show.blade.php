...
@section('content')
    ...
    <form action="/commentary/{{$post->slug}}" method="post" class="ml-1 mr-1">
        @csrf
    ...
    <div class="mb-3">
        <li class="list-group-item list-group-item-success ml-1 mr-1">{{$comments->count()}} Commentary</li>

    </div>
    @foreach($comments as $comment)
        <div class="mb-3 ml-1 mr-1 bd-callout bd-callout-danger">
            <div>
            ...
            <div class="d-flex justify-content-between">
                ...
                <div>
                    <form action="/commentary/{{$comment->id}}" method="post" class="mr-2 ml-3">
                        @csrf
                        @method("DELETE")
                        <button type="submit">
